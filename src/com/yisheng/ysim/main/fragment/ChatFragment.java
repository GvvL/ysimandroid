...
import com.yisheng.ysim.main.activity.ChatSettingGroupActivity;
import com.yisheng.ysim.main.activity.ChatSettingSingleActivity;
import com.yisheng.ysim.main.FXConstant;
import com.yisheng.ysim.main.activity.UserDetailsActivity;
...
import com.yisheng.ysim.main.ys.YSProfileActivity;
import com.yisheng.ysim.ui.ChatRoomDetailsActivity;
import com.yisheng.ysim.ui.ContextMenuActivity;
import com.yisheng.ysim.ui.ForwardMessageActivity;
import com.yisheng.ysim.ui.GroupDetailsActivity;
import com.yisheng.ysim.ui.ImageGridActivity;
import com.yisheng.ysim.ui.PickAtUserActivity;
import com.yisheng.ysim.ui.VideoCallActivity;
import com.yisheng.ysim.ui.VoiceCallActivity;
import com.yisheng.ysim.widget.ChatRowVoiceCall;
import com.yisheng.easeui.controller.EaseUI;
import com.yisheng.easeui.widget.chatrow.EaseChatRow;
...
import com.yisheng.ysim.domain.EmojiconExampleGroupData;
import com.yisheng.ysim.domain.RobotUser;
import com.yisheng.easeui.EaseConstant;
import com.yisheng.easeui.ui.EaseChatFragment;
import com.yisheng.easeui.ui.EaseChatFragment.EaseChatFragmentHelper;
import com.yisheng.easeui.widget.chatrow.EaseCustomChatRowProvider;
import com.yisheng.easeui.widget.emojicon.EaseEmojiconMenu;
...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentHelper {
    ...
    protected void setUpView() {
        ...
        //点击事件
        if (chatType == Constant.CHATTYPE_SINGLE&&IS_CS){
            getView().findViewById(R.id.iv_setting_single).setVisibility(View.GONE);
            getView().findViewById(R.id.iv_cs_more).setVisibility(View.VISIBLE);
            //个人中心点击
            getView().findViewById(R.id.iv_profile).setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    getActivity().startActivity(new Intent(getActivity(), YSProfileActivity.class));
                }
            });
            //更多点击事件
            getView().findViewById(R.id.iv_cs_more).setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
    ...
    protected void sendTextMessage(String content) {
        ...
        //自动回复
        if(!toChatUsername.equals("22222")){
            return;
        }
        List<Param> params = new ArrayList<>();
        params.add(new Param("userId", EMClient.getInstance().getCurrentUser()));
        params.add(new Param("msg",content));
        OkHttpManager.getInstance().post(params, FXConstant.URL_CS_SEND_MSG, new OkHttpManager.HttpCallBack() {
            @Override
